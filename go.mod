...
require (
	...
	github.com/hashicorp/consul-template v0.29.2 // indirect
	...
	github.com/hashicorp/vault-plugin-auth-alicloud v0.13.0 // indirect
	github.com/hashicorp/vault-plugin-auth-cf v0.13.0 // indirect
