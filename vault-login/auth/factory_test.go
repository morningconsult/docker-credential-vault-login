...
func TestNewClientFactoryAWSIAMAuth_Success(t *testing.T) {
...
// TestNewClientFactoryAWSIAMAuth_BadVaultAddr tests that the
// incorrect VAULT_ADDR value is set, ClientFactoryAWSIAMAuth.NewClient()
// returns an error.
func TestNewClientFactoryAWSIAMAuth_BadAddr(t *testing.T) {
	const role = "test-iam-role"
...
// TestNewClientFactoryAWSIAMAuth_UnconfiguredRole checks that when
...
func TestNewClientFactoryAWSIAMAuth_UnconfiguredRole(t *testing.T) {
...
func TestClientFactoryAWSEC2Auth_Success(t *testing.T) {
...
// TestClientFactoryAWSEC2Auth_UnconfiguredRole tests that
// if the Vault role is not configured to login via the AWS EC2
// endpoint then the appropriate error is returned
func TestClientFactoryAWSEC2Auth_UnconfiguredRole(t *testing.T) {
	const pkcs7 = `
...
// // TestClientFactoryAWSEC2Auth_BadPKCS7 tests that if
...
func TestClientFactoryAWSEC2Auth_BadPKCS7(t *testing.T) {
	const pkcs7 = `
...
// // TestClientFactoryAWSEC2Auth_NonEC2 simulates
...
func TestClientFactoryAWSEC2Auth_NotEC2(t *testing.T) {
	const role = "dev-role-ec2"
